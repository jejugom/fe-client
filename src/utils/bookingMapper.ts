 ...
 */
export function getBranchNameById(branchId: number | string): string {
 ...
 */
export function getProductNameByCodeWrapper(productCode: string): string {
 ...
 */
export function transformBookingData(bookingData: any) {
  return {
    ...bookingData,
    bank_name: getBranchNameById(bookingData.branchId || bookingData.bank_name),
    prdt_name: getProductNameByCodeWrapper(
      bookingData.finPrdtCode || bookingData.prdt_name
    ),
  };
}
