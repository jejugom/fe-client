<template>
  <template v-if="type === 'type1'">
    <div class="flex gap-5 font-semibold">
      <button
        class="bg-secondary-100 text-secondary-500 h-10.5 w-33 rounded-lg transition-colors duration-300"
        @click="onClick1"
      >
        {{ label1 }}
      </button>
      <button
        class="bg-primary-100 text-primary-500 h-10.5 w-33 rounded-lg transition-colors duration-300"
        @click="onClick2"
      >
        {{ label2 }}
      </button>
