<template>
  <div>
    <h2 class="text-primary-300 mb-3 text-2xl font-bold">
      자녀에게 미리 마음을 전하고 싶다면
    </h2>
    ...
    <div class="mb-16 space-y-6">
      <GiftStartCard
        :icon="Gift1"
        title="증여"
        description="자녀나 손주에게 미리 재산을 전하고 싶으신가요? 간단한 입력으로 맞춤 증여 계획과 절세 전략을 확인해보세요."
        :buttons="[
          {
            label: '증여 시뮬레이션 시작하기',
            color: 'primary',
            onClick: goToGiftStart,
          },
        ]"
      />
      ...
      <GiftStartCard
        :icon="Gift2"
        title="상속"
        description="가족에게 소중한 자산을 안전하게 남기고 싶으신가요? 상속 계획부터 유언장 작성까지 한 번에 준비해보세요."
        :buttons="[
          {
            label: '유언장 작성하기',
            color: 'primary',
            onClick: goToInheritanceStart,
          },
          {
            label: '상속 관련 상품 보러가기',
            color: 'surface',
            onClick: goToInheritanceProducts,
          },
        ]"
      />
    </div>
